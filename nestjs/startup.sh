...
sudo apt-get update
sudo apt-get install -y bc curl wget git apt-transport-https ca-certificates gnupg lsb-release software-properties-common bash-completion dnsutils telnet iputils-ping whiptail ffmpeg
